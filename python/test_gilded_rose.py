...
class GildedRoseTest(unittest.TestCase):
    ...
    def test_backstage_quality_increases_by_2_when_sell_in_10_or_less(self):
        items = [Item("Backstage passes to a TAFKAL80ETC concert", 10, 20)]
        GildedRose(items).update_quality()
        self.assertEqual(22, items[0].quality)
        self.assertEqual(9, items[0].sell_in)

    def test_backstage_quality_increases_by_3_when_sell_in_5_or_less(self):
    ...
    def test_backstage_quality_never_above_50(self):
    ...
    def test_conjured_quality_decreases_by_4_after_sell_in(self):
